...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 22.0, 645.0, 154.0, 87.0 ],
					"style" : "",
					"text" : "Data fed from above fed into button to indicate spike. Each blip feeds into the color picker to change the color/saturation settings"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 202.0, 251.0, 150.0, 47.0 ],
					"style" : "",
					"text" : "This section to the left analyizes audio to recognize audio spikes"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 714.0, 303.0, 256.0, 60.0 ],
					"style" : "",
					"text" : "By selecting the first dropdown you can change the pattern type from sine+ to one of the other options; experimenting with the way different patterns react to the audio track"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 768.0, 129.0, 160.0, 74.0 ],
					"style" : "",
					"text" : "Audio splitter provides data for different frequencies allowing it to feed data into different sections of the pattern mapper below"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 333.0, 45.0, 150.0, 60.0 ],
					"style" : "",
					"text" : "Open audio file \"Yogi.mp3\" Located in Github by selecting source: sound file"
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 705.5, 370.0, 268.0, 198.0 ],
					"presentation" : 1,
